...
function B = bfilter2(A,w,sigma,q)
...
if size(A,3) == 1
   B = bfltGray(A,w,sigma(1),sigma(2),q);
else
   B = bfltColor(A,w,sigma(1),sigma(2),q);
end


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Implements bilateral filtering for grayscale images.
function B = bfltGray(A,w,sigma_d,sigma_r,u)
...
% Create waitbar.
m=strcat('Applying bilateral filter on image', num2str(u));
h = waitbar(0,m);
...
function B = bfltColor(A,w,sigma_d,sigma_r,u)
